...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-gtsummary-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-gtsummary-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-gtsummary
# for installing globally
pixi global install r-gtsummary
```
...
It is possible to list all of the versions of `r-gtsummary` available on your platform:
...
```
pixi search r-gtsummary --channel conda-forge
```
